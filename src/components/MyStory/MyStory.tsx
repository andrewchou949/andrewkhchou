...
const MyStory = () => {
    return (
        <div id="story" className="section storySection">
        <h1 className="myStoryTitle">My Story</h1>
        <div className="storyContent">
          <h2>Early Influences:</h2>
            <p>
            The COVID-19 pandemic was a pivotal moment for many, but for me, it highlighted the immense potential of 
            ...
            (I was 9 years old at the time), solidified my interest in the field.
            </p>
          <h2>Challenges:</h2>
            <p>
            Back in 2017, I started my college journey at Shoreline Community College. As an international student, 
            ...
            where I fully immersed myself in Computer Science and Software Engineering.
            </p>
          <h2>Milestones:</h2>
            <p>
            One of the coolest things I did during my studies was creating a cross-platform app, 
          ...
          <h2>Personal Motivation:</h2>
            <p>
            You know, there's something cool about diving into the tech world. It feels a bit like 
            ...
            there's always a new puzzle to solve, and I'm here and ready for it!
            </p>
          <h2>Hobbies/Interests:</h2>
            <p>
            Off the keyboard and away from code, I often lose myself in the rhythm of music. While I 
